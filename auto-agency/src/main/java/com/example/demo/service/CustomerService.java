...
public class CustomerService  {
	...
	public CustomerService(CustomerRepo customerRepo , UserAddressRepo userAddressRepo ) {
...
//		customer.setPassword(passwordEncoder.encode(customer.getPassword()));
	...
	{
		Optional<Customer> optionalCustomer = customerRepo.findByEmailId(loginCredentials.getUsername());
